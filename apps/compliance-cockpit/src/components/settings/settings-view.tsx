...
export function SettingsView() {
  ...
  const inputStyle = {
    ...
    background: 'hsl(var(--secondary))', color: TEXT,
  }
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-3 gap-3 pt-1">
            {[
              ...
              <div key={label} className="rounded-lg p-3" style={{ background: 'hsl(var(--secondary))' }}>
      ...
      <Section title="SDK Quick Start">
        <div className="relative">
          <pre
            ...
            style={{ background: 'hsl(var(--secondary))', color: TEXT, fontFamily: 'monospace' }}
          >
            {QUICK_START}
          </pre>
          <button
        ...
        <div className="mt-3 grid grid-cols-3 gap-2">
          {[
            ...
            <div key={label} className="rounded-md px-3 py-2 flex justify-between items-center"
              style={{ background: 'hsl(var(--secondary))', border: `1px solid ${BORDER}` }}>
